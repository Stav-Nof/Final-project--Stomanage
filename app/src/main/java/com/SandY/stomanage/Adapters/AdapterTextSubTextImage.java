...
public class AdapterTextSubTextImage extends ArrayAdapter {
    ...
    public AdapterTextSubTextImage(Activity context, List<String> itemNames, List<String> SubitemNames, String path, String fileType, Drawable noImag) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        textView2.setText(SubitemNames.get(position));
